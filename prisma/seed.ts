...
const EXPANDED_STAFF_USERS = [
    ...
    },
    {
        ...
        firstName: 'Lars',
        lastName: 'Nordin',
        email: 'lars.nordin@medsphere.local',
        username: 'lars.nordin',
        password: DEMO_PASSWORD,
        role: 'Doctor',
    },
    {
        ...
        firstName: 'Nia',
        lastName: 'Mensah',
        email: 'nia.mensah@medsphere.local',
        username: 'nia.mensah',
        password: DEMO_PASSWORD,
        role: 'Doctor',
    },
    {
        ...
        firstName: 'Hiro',
        lastName: 'Yamamoto',
        email: 'hiro.yamamoto@medsphere.local',
        username: 'hiro.yamamoto',
        password: DEMO_PASSWORD,
        role: 'Doctor',
    },
    {
        ...
        firstName: 'Mateusz',
        lastName: 'Kowalski',
        email: 'mateusz.kowalski@medsphere.local',
        username: 'mateusz.kowalski',
        password: DEMO_PASSWORD,
        role: 'Doctor',
    },
    {
        ...
        firstName: 'Valentina',
        lastName: 'Rossi',
        email: 'valentina.rossi@medsphere.local',
        username: 'valentina.rossi',
        password: DEMO_PASSWORD,
        role: 'Doctor',
    },
    {
        ...
        firstName: 'Mariam',
        lastName: 'Al-Khatib',
        email: 'mariam.al-khatib@medsphere.local',
        username: 'mariam.al-khatib',
        password: DEMO_PASSWORD,
        role: 'Doctor',
    },
    {
        ...
        firstName: 'Elena',
        lastName: 'Popescu',
        email: 'elena.popescu@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Ravi',
        lastName: 'Menon',
        email: 'ravi.menon@medsphere.local',
        username: 'ravi.menon',
        password: DEMO_PASSWORD,
        role: 'Doctor',
    },
    {
        ...
        firstName: 'Camila',
        lastName: 'Torres',
        email: 'camila.torres@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Santiago',
        lastName: 'Alvarez',
        email: 'santiago.alvarez@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Layla',
        lastName: 'Haddad',
        email: 'layla.haddad@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Ibrahim',
        lastName: 'Hassan',
        email: 'ibrahim.hassan@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Ana',
        lastName: 'Ribeiro',
        email: 'ana.ribeiro@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Maya',
        lastName: 'Singh',
        email: 'maya.singh@medsphere.local',
        username: 'maya.singh',
        password: DEMO_PASSWORD,
        role: 'Doctor',
    },
    {
        ...
        firstName: 'Noah',
        lastName: 'Stein',
        email: 'noah.stein@medsphere.local',
        username: 'noah.stein',
        password: DEMO_PASSWORD,
        role: 'Doctor',
    },
    {
        ...
        firstName: 'Zara',
        lastName: 'Khan',
        email: 'zara.khan@medsphere.local',
        username: 'zara.khan',
        password: DEMO_PASSWORD,
        role: 'Doctor',
    },
    {
        ...
        firstName: 'Jonas',
        lastName: 'Bergstrom',
        email: 'jonas.bergstrom@medsphere.local',
        username: 'jonas.bergstrom',
        password: DEMO_PASSWORD,
        role: 'Doctor',
    },
    {
        ...
        firstName: 'Fatima',
        lastName: 'Zahra',
        email: 'fatima.zahra@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'James',
        lastName: 'OConnor',
        email: 'james.oconnor@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Amara',
        lastName: 'Okafor',
        email: 'amara.okafor@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Mateo',
        lastName: 'Silva',
        email: 'mateo.silva@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Leila',
        lastName: 'Farah',
        email: 'leila.farah@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Aleksei',
        lastName: 'Petrov',
        email: 'aleksei.petrov@medsphere.local',
        username: 'aleksei.petrov',
        password: DEMO_PASSWORD,
        role: 'Doctor',
    },
    {
        ...
        firstName: 'Sara',
        lastName: 'Lindgren',
        email: 'sara.lindgren@medsphere.local',
        username: 'sara.lindgren',
        password: DEMO_PASSWORD,
        role: 'Doctor',
    },
    {
        ...
        firstName: 'Kenji',
        lastName: 'Watanabe',
        email: 'kenji.watanabe@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Sofia',
        lastName: 'Martinez',
        email: 'sofia.martinez@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Amina',
        lastName: 'Diallo',
        email: 'amina.diallo@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Noor',
        lastName: 'Al-Farsi',
        email: 'noor.al-farsi@medsphere.local',
        username: 'noor.al-farsi',
        password: DEMO_PASSWORD,
        role: 'Nurse',
    },
    {
        ...
        firstName: 'Elena',
        lastName: 'Markovic',
        email: 'elena.markovic@medsphere.local',
        username: 'elena.markovic',
        password: DEMO_PASSWORD,
        role: 'Lab Technician',
    },
    {
        ...
        firstName: 'Omar',
        lastName: 'Rahman',
        email: 'omar.rahman@medsphere.local',
    ...
    },
    {
        ...
        firstName: 'Iris',
        lastName: 'Van Dijk',
        email: 'iris.van-dijk@medsphere.local',
        username: 'iris.van-dijk',
        password: DEMO_PASSWORD,
        role: 'Receptionist',
    },
] as const;
